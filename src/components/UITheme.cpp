...
#include "components/themes/industrial/IndustrialTheme.h"
...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::LYRA_3_COVERS:
      ...
      break;
    case CrossPointSettings::UI_THEME::INDUSTRIAL:
      LOG_DBG("UI", "Using Industrial theme");
      currentTheme = std::make_unique<IndustrialTheme>();
      currentMetrics = &IndustrialMetrics::values;
      break;
  }
}
